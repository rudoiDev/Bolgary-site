...
const animItems2 = document.querySelectorAll('.build_img, input');
elemScroll([animItems2[]], 'animate__bounceInRight');
elemScroll([animItems2[0]], 'animate__bounceInLeft');
elemScroll([animItems2[2]], 'animate__bounceInRight');
elemScroll([animItems2[3]], 'animate__bounceInLeft');
elemScroll([animItems2[4]], 'animate__bounceInRight');
elemScroll([animItems2[5]], 'animate__bounceInLeft');
